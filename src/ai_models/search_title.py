...
class SearchTitleModel(ModelBase, model_cache="search_title_cache.pkl"):
    model = None
    id_map = None
    matrix = None
    
    @classmethod
    def load(cls, movie_titles: list[str] | None = None):
    ...
    @classmethod
    def predict(cls, movie_title: str, top_n: int = 20) -> list[int]:
